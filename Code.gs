...
const SCHEMAS = {
  ...
  rekap_program: {
    ...
    importAliases: {
      uic:["UIC"],
      program:["Program","Nama Program","PROGRAM","Program Pelatihan","Nama Program Pelatihan"],
      subprogram:["Subprogram","Sub Program","Sub-Program","SUBPROGRAM"],
      pengelola:["Pengelola","PIC","Nama Pengelola"],
      tgl_awal:["Tgl Awal","Tanggal Awal","Tgl Mulai"],
      tgl_akhir:["Tgl Akhir","Tanggal Akhir","Tgl Selesai"],
      metode:["Metode","METODE"],
      jumlah_hari:["Jumlah Hari","Jumlah Batch","JUMLAH HARI","JUMLAH BATCH"],
      learner:["Learner","LEARNER","Jumlah Learner"],
      biaya_pelatihan:["Biaya Pelatihan","BIAYA PELATIHAN"]
    }
  },
